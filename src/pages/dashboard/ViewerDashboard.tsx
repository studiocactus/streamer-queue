...
import { Tv2, Send, ThumbsUp, Clock, Bell, Plus, Search } from 'lucide-react'
...
import { formatRelativeDate, statusLabel, categoryLabel } from '@/lib/utils'
...
export default function ViewerDashboard() {
  ...
  const completed = stats.suggestions.filter((s) => s.status === 'completed').length
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              <div className="flex items-center gap-1.5 text-xs bg-brand-purple/10 text-brand-purple border border-brand-purple/20 rounded-full px-2 py-0.5">
